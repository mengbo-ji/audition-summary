...
alert(s.has(function() {})); // false复制代码
```
...
console.log([...s]); // ["val1", "val2", "val3"]复制代码
```
...
alert(ws3.has(stringVal)); // true复制代码
```
...
disabledElements.add(loginButton);复制代码
```
...
console.log(arr1 === arr2); // false复制代码
```
...
console.log(map2); // Map {1 => 2, 3 => 4}复制代码
```
...
console.log(arr2); // [0, 1, 2, 3, 4, 5]复制代码
```
...
arr1[0].foo = 'bar';
console.log(arr2[0]); // { foo: 'bar' }复制代码
```
